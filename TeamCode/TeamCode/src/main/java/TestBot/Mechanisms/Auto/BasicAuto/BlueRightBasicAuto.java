...
public class  BlueRightBasicAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sleep(15000);
        encoderDrive(DRIVE_SPEED, -20,-20,5.0); //STRAFE LEFT
        runtime.reset();
       ...
       /*encoderDrive(DRIVE_SPEED,10,10,2.0); //back 2 inches
        ...
        encoderDrive(DRIVE_SPEED, 20,-20,5.0); //STRAFE LEFT
        encoderDrive(DRIVE_SPEED,-80,-80,5.0); //forward 78 inches to park
        encoderDrive(DRIVE_SPEED, 4,-4,5.0); //STRAFE LEFT
        encoderDrive(DRIVE_SPEED,-30,30,2.0);//get out of the way right*/

       encoderDrive(DRIVE_SPEED,100,100,9.0);
