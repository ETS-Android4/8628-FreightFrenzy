...
@Disabled
@Autonomous(name="RedRightParkOnlyDelay")

public class  RedRightParkOnlyDelay extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,-115,-115,5.0); //forward 115 inches to park
