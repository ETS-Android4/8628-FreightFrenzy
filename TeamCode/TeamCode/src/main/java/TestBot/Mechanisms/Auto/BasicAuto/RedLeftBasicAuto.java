...
@Disabled
@Autonomous(name="RedLeftBasicAuto")

public class  RedLeftBasicAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,  -20,  -20, 3.0);  // S1: Forward 6 Inches with 3 Sec timeout
        ...
        encoderDrive(DRIVE_SPEED,30,30,5.0); //backward 78 inches to park
       // encoderDrive(DRIVE_SPEED,-6,6,3);
        encoderDrive(DRIVE_SPEED,15,-15,2.0);
        encoderDrive(DRIVE_SPEED,76,76,5.0);
        encoderDrive(DRIVE_SPEED,-15,15,2.0);//get out of the way left
