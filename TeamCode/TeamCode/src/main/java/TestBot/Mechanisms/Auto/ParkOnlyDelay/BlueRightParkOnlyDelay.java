package TestBot.Mechanisms.Auto.ParkOnlyDelay;
...
@Disabled
@Autonomous(name="BlueRightParkOnlyDelay")

public class  BlueRightParkOnlyDelay extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("WARNING", "Start this program facing warehouse");
        ...
        sleep(1500);
        encoderDrive(DRIVE_SPEED,-90,-90,5.0); //forward 90 inches to park
