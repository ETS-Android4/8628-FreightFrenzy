package TestBot.Mechanisms.Auto.DepotPark;
...
@Autonomous(name="RedRightDepotPark")
@Disabled
public class  RedRightDepotPark extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,-44,-44,3.0);
