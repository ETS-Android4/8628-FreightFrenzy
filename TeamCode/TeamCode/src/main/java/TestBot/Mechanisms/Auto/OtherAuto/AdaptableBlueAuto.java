package TestBot.Mechanisms.Auto.OtherAuto;
...
@Disabled
@Autonomous(name="AdaptableBlueAuto")

public class  AdaptableBlueAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED, -5,5,2.0); //strafe right
        encoderDrive(DRIVE_SPEED,   35, 35, 4.0);  // go back
        encoderDrive(DRIVE_SPEED, 12.5,-12.5,2.0); //STRAFE LEFT
       /* runtime.reset();
        while(8.0>runtime.seconds()){           //SPIN DUCKY
            robot.duckyMover.setPower(1.0);
        }
        robot.duckyMover.setPower(0);*/
        encoderDrive(DRIVE_SPEED,-10,-10,2.0); //forward 2 inches
        encoderDrive(DRIVE_SPEED,18,-18,2.0); // strafe 6 inches LEFT
        ...
        encoderDrive(DRIVE_SPEED,-90,-90,5.0); //forward 78 inches to park
        encoderDrive(DRIVE_SPEED,6,-6,3); //CORRECT LEFT
        encoderDrive(DRIVE_SPEED,-25,-25,5.0); //FORWARD
