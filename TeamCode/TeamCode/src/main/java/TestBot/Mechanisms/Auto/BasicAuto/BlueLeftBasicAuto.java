package TestBot.Mechanisms.Auto.BasicAuto;
...
@Disabled
@Autonomous(name="BlueLeftBasicAuto")

public class  BlueLeftBasicAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED, 75,-75,4.0); //STRAFE LEFT
        runtime.reset();
        ...
        encoderDrive(DRIVE_SPEED,10,10,3.0); //back 2 inches
        turnLeft(TURN_SPEED,.9);
        encoderDrive(DRIVE_SPEED,8,-8,2); //CORRECT LEFT BETTER?
        encoderDrive(DRIVE_SPEED,-20,-20,5.0); //forward 78 inches to park
        encoderDrive(DRIVE_SPEED,10,-10,5.0); //to the left to the left to the left to the left
        encoderDrive(DRIVE_SPEED,-70,-70,5.0); //forward 78 inches to park

        encoderDrive(DRIVE_SPEED,-45,45,2.0);//get out of the way right
        //encoderDrive(DRIVE_SPEED,-25,-25,5.0); //forward more
     /*  runtime.reset();
        while(3.0>runtime.seconds()){           //SPIN DUCKY
